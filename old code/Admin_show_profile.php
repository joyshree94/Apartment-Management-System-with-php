...
if($_SERVER['REQUEST_METHOD']=='POST' && isset($_POST['YES'])){
	$user_update = $user->Update_permission1($userPhone,$_POST);
	
}
if($_SERVER['REQUEST_METHOD']=='POST' && isset($_POST['NO'])){
	$user_update = $user->Delete_permission1($userPhone);
  ...
  <body>
	   ...
	   <div class="panel panel-default">
		   <div class="panel-heading">
			 <h2>user profile<span class="pull-right"><a class="btn btn-primary" href="customer_details.php">back</a></span></h2>
		   </div>
